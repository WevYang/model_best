...
- OpenAI GPT-4V / GPT-4o / GPT-5 系列、Anthropic Claude 系列、Google Gemini 闭源系列都没有公开同类可横比学术视觉幻觉表格，但分别公开了 system-card 级 factuality、safety、grounding 或内部 eval。
...
代表主表优先展示每个系列最有代表性的官方分数；完整尺寸表见 Excel。Qwen3-VL-235B-A22B 的两个数分别来自 thinking / instruct，SimpleVQA 属 factuality-related，不计入 pure hallucination。
...
| OpenAI GPT-4V / GPT-4o / GPT-5 系列 | - | - | - | - | - | system-card factuality / safety / internal eval | 当前未发现同类可横比 direct 表格。 |
| Anthropic Claude 系列 | - | - | - | - | - | system-card safety / factuality / internal risk eval | 当前未发现同类可横比 direct 表格。 |
| Google Gemini 闭源系列 | - | - | - | - | - | factuality / grounding / safety / multimodal capability eval | 当前未发现同类可横比 direct 表格；PaliGemma / Gemma 3 另列，不与 Gemini 闭源混比。 |
